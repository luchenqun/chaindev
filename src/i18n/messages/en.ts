export const en = {
  ...
  login: {
    ...
    githubDescription:
      'Best for developers who want a fast sign-in flow with an existing GitHub account.',
    emailDescription:
      'Best for self-hosted environments that prefer an email-based sign-in flow.',
