...
export function isCosmosHomeRouteActive(pathname: string, activeMode: ActivePlatformMode) {
...
export function isCosmosRouteActive(pathname: string, activeMode: ActivePlatformMode) {
...
export function isCosmosLiveBlockRouteActive(pathname: string, activeMode: ActivePlatformMode) {
  return isCosmosRouteActive(pathname, activeMode);
}

export function isEvmRouteActive(pathname: string, activeMode: ActivePlatformMode) {
  if (pathname !== '/') {
