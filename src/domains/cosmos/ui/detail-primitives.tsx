...
export function formatTimestampWithSeconds(
...
export function CosmosDetailRow({
  label,
  value,
  mono = false,
}: {
...
export function CosmosDetailGroup({
  children,
  separated = false,
  plain = false,
}: {
    ...
    <div
      className={
        separated
          ...
          : 'border-t border-slate-200 py-2.5 first:border-t-0'
      }
    >
      {children}
    </div>
...
export function CosmosDetailTag({
  children,
  tone = 'neutral',
}: {
  children: ReactNode;
