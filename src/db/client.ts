...
function ensureWorkbenchSchema() {
  sqlite.exec(`
    ...
    CREATE TABLE IF NOT EXISTS cosmos_address_tags (
      id TEXT PRIMARY KEY NOT NULL,
      user_id TEXT NOT NULL,
      provider_profile_id TEXT NOT NULL,
      provider_name TEXT,
    ...
    CREATE INDEX IF NOT EXISTS cosmos_address_tags_user_id_idx ON cosmos_address_tags(user_id);
    ...
    CREATE UNIQUE INDEX IF NOT EXISTS cosmos_address_tags_scope_address_unique
      ON cosmos_address_tags(user_id, provider_profile_id, address_lower);
